...
#pragma prefast( suppress: 28107, "prefast cannot work out that CdAcquireFileExclusive acquires the Fcb")
...
#pragma prefast( suppress: 28107, "prefast can't work out that the FCB is acquired at this point." )
...
#pragma prefast( suppress: 28107, "prefast can't work out that the VCB is acquired at this point." )
